...
[![Run on Brainlife.io](https://img.shields.io/badge/Brainlife-bl.app.327-blue.svg)](https://doi.org/10.25663/brainlife.app.327)
...
### Citations
We kindly ask that you cite the following article and the articles in the following [link](https://dipy.org/documentation/1.1.1./reference_cmd/dipy_gibbs_ringing/) when publishing papers and code using this code.
