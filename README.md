...
# Dipy remove gibbs ringing on Diffusion MRI
...
### DIPY
- This is a Brainlife wrapper App stemming from the [`dipy_gibbs_ringing`](https://dipy.org/documentation/latest/reference_cmd/dipy_gibbs_ringing/) workflow.
